...
public class GeneratorTests
{
    ...
    )
    {
        var expected = $$"""
                         ...
                         {{publicClass.InterpolateCondition("public", "internal")}}{{staticClass.InterpolateCondition(" static", string.Empty)}}{{partial.InterpolateCondition(" partial", string.Empty)}} class ActivityEntrySortRuleNames
                         {
                             ...
                             public{{staticMembers.InterpolateCondition(" static", string.Empty)}} CultureInfo? CultureInfo { get; set; }

                             /// <summary>
                             /// Looks up a localized string similar to Oldest.
                             /// </summary>
                             public{{staticMembers.InterpolateCondition(" static", string.Empty)}} string{{nullForgivingOperators.InterpolateCondition(string.Empty, "?")}} CreateDate => ResourceManager.GetString(nameof(CreateDate), CultureInfo){{nullForgivingOperators.InterpolateCondition("!", string.Empty)}};

                             /// <summary>
                             /// Looks up a localized string similar to Newest.
                             /// </summary>
                             public{{staticMembers.InterpolateCondition(" static", string.Empty)}} string{{nullForgivingOperators.InterpolateCondition(string.Empty, "?")}} CreateDateDescending => ResourceManager.GetString(nameof(CreateDateDescending), CultureInfo){{nullForgivingOperators.InterpolateCondition("!", string.Empty)}};
                         }
                         """;
    ...
    )
    {
        ...
        var expected = $$"""
                         ...
                         {{publicClass.InterpolateCondition("public", "internal")}}{{partial.InterpolateCondition(" partial", string.Empty)}}{{staticClass.InterpolateCondition(" static", string.Empty)}} class ActivityEntrySortRuleNames
                         {{{string.IsNullOrEmpty(innerClassInstanceName).InterpolateCondition(string.Empty, innerDefinition)}}
                             {{publicClass.InterpolateCondition("public", "internal")}}{{partial.InterpolateCondition(" partial", string.Empty)}}{{staticClass.InterpolateCondition(" static", string.Empty)}} class {{innerClassName}}
                             {
                                 private static ResourceManager? s_resourceManager;
        ...
        errorsAndWarnings.Should().BeNullOrEmpty();
        sourceCode.ReplaceLineEndings().Should().Be(expected.IndentCode());
    }
