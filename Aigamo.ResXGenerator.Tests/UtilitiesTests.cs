...
public class UtilitiesTests
{
    ...
    public void SanitizeNamespace(string input, string expected) => Utilities.SanitizeNamespace(input).Should().Be(expected);
    ...
    [InlineData("8Ns", "8Ns")]
    [InlineData("..Ns", ".Ns")]
    public void SanitizeNamespaceWithoutFirstCharRules(string input, string expected) => Utilities.SanitizeNamespace(input, false).Should().Be(expected);
