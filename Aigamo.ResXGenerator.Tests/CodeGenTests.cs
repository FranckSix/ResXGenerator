...
public class CodeGenTests
{
    ...
    {
        var visibilityClassKeyWord = publicClass ? "public" : "internal";
        var partialClassKeyWord = partial ? " partial " : " ";
        var staticClassKeyWord = staticClass ? "static" : string.Empty;
        var staticMemberKeyWord = staticMembers ? "static " : " ";
        var forgivingOperator = nullForgivingOperators ? string.Empty : "?";
        var expected = $$"""
                         // ------------------------------------------------------------------------------
                         // <auto-generated>
                         ...
                         {{visibilityClassKeyWord}}{{partialClassKeyWord}}{{staticClassKeyWord}} class ActivityEntrySortRuleNames
                         {

                             /// <summary>
                             /// Looks up a localized string similar to Oldest.
                             /// </summary>
                             public {{staticMemberKeyWord}}string{{forgivingOperator}} CreateDate => GetString_1030_6("Oldest", "OldestDaDK", "OldestDa");

                             /// <summary>
                             /// Looks up a localized string similar to Newest.
                             /// </summary>
                             public {{staticMemberKeyWord}}string{{forgivingOperator}} CreateDateDescending => GetString_1030_6("Newest", "NewestDaDK", "NewestDa");
                         }
                         """;
