...
public class SettingsTests
{
    ...
    public void GlobalDefaults()
    {
        ...
        globalOptions.SkipHelpers.Should().BeFalse();
    }
    ...
    private class AnalyzerConfigOptionsStub : AnalyzerConfigOptions
    {
        ...
        public string? ResXGenerator_SkipHelperClass { get; init; }
        ...
        public override bool TryGetValue(string key, [NotNullWhen(true)] out string? value)
        {
            value = key switch
            {
                ...
                "build_property.ResxGenerator_SkipHelperClass" => ResXGenerator_SkipHelperClass,
